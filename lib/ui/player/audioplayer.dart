...
import 'package:neom_music_player/ui/widgets/equalizer.dart';
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: Text(PlayerTranslationConstants.ok.tr),
                ),
                const SizedBox(
                  width: 20,
                ),
                    ...
                    PopupMenuButton(
                      ...
                      itemBuilder: (context) => offline
                          ? [
                              ...
                              if (Hive.box(AppHiveConstants.settings).get(
                                'supportEq',
                                defaultValue: false,
                              ) as bool)
                                PopupMenuItem(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 10.0),
                                      Text(
                                        PlayerTranslationConstants.equalizer.tr,
                                      ),
                                    ],
                                  ),
                                ),
                              PopupMenuItem(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 10.0),
                                    Text(
                                      PlayerTranslationConstants.songInfo.tr,
                                    ),
                                  ],
                                ),
                              ),
