    ...
    return Scaffold(
        ...
        body: Container(
          ...
          children: [
            ...
            // ),
            HiveBoxSwitchTile(
              title: Text(PlayerTranslationConstants.getLyricsOnline.tr,),
              subtitle: Text(PlayerTranslationConstants.getLyricsOnlineSub.tr,),
              keyName: 'getLyricsOnline',
              isThreeLine: true,
              defaultValue: true,
            ),
            HiveBoxSwitchTile(
              title: Text(PlayerTranslationConstants.stopOnClose.tr,),
              subtitle: Text(PlayerTranslationConstants.stopOnCloseSub.tr,),
              isThreeLine: true,
