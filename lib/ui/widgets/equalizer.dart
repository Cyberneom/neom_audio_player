    ...
    return AlertDialog(
      ...
      content: SafeArea(
        child: Column(
          ...
          children: [
            SwitchListTile(
              title: Text(PlayerTranslationConstants.equalizer.tr),
              value: enabled,
              activeColor: Theme.of(context).colorScheme.secondary,
              onChanged: (value) {
                enabled = value;
                Hive.box(AppHiveConstants.settings).put('setEqualizer', value);
...
class _VerticalSliderState extends State<VerticalSlider> {
  ...
  void setGain(int bandIndex, double gain) {
    Hive.box(AppHiveConstants.settings).put('equalizerBand$bandIndex', gain);
    widget.audioHandler
