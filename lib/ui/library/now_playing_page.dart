...
class NowPlayingPageState extends State<NowPlayingPage> {
  ...
  Future<void> _initAudioHandler() async {
    final handler = await NeomAudioProvider().getAudioHandler();
    if (mounted) {
      setState(() {
        ...
        builder: (context, snapshot) {
          ...
          return Scaffold(
            ...
            body: processingState == AudioProcessingState.idle
              ...
              child: emptyScreen(
                context, 3,
                AudioPlayerTranslationConstants.nothingIs.tr, 14.0,
                AudioPlayerTranslationConstants.playingCap.tr, 38,
                AudioPlayerTranslationConstants.playSomething.tr, 28.0,
              ),
              ...
              builder: (context, snapshot) {
                ...
                return mediaItem == null
                  ...
                  title: AudioPlayerTranslationConstants.nowPlaying.tr,
                  localImage: mediaItem.artUri
                      ?.toString().startsWith('file:') ?? false,
                  imageUrl: (mediaItem.artUri?.toString().startsWith('file:') ?? false
