...
import 'package:neom_music_player/utils/helpers/spotify_country.dart';
        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: [
              Tab(
                child: Text(
                  PlayerTranslationConstants.local.tr,
                  style: TextStyle(
              ...
              Tab(
                child: Text(
                  PlayerTranslationConstants.global.tr,
                  style: TextStyle(
                    color: Theme.of(context).textTheme.bodyLarge!.color,
                  ),
                ),
          ...
          title: Text(
            PlayerTranslationConstants.spotifyCharts.tr,
            style: TextStyle(
              fontSize: 18,
              color: Theme.of(context).textTheme.bodyLarge!.color,
            ),
